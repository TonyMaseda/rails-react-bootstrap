...
* Ruby [3.1.3](https://www.ruby-lang.org/en/downloads/releases/)
* Ruby on Rails [7.0.4](https://rubygems.org/gems/rails/versions)
...
* Stimulus [3.2.1](https://github.com/hotwired/stimulus/releases) (yarn)
* React [18.2.0](https://reactjs.org/versions/) (yarn)
* Bootstrap [5.2.3](https://getbootstrap.com/docs/versions/) (yarn)
```
